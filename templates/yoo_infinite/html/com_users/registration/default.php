	...
	<form id="register" class="small style form-validate" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post">
		...
		<div class="grid-box width50">
			...
			<h3>Mijn gegevens</h3>
				<ul class="rawlist formlist">					
					...
					<li><?php echo $this->form->getField('telefoon','profile')->label; ?>
						<?php echo $this->form->getField('telefoon','profile')->input; ?>
					</li>						
					<li><?php echo $this->form->getField('mobiel','profile')->label; ?>
						<?php echo $this->form->getField('mobiel','profile')->input; ?>
					</li>					
				</ul>
				<ul class="rawlist formlist">
		...
		<div class="grid-box width50">
			...
			<ul class="rawlist formlist checks">
				<li><!--<?php echo $this->form->getField('newsletter','profile')->label; ?><br/>-->
						<?php echo $this->form->getField('newsletter','profile')->input; ?>
				</li>			
